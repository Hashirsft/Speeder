...
var fireProbeGraphic = function(sp, DEBUG_LEVEL) {
    ...
    */
    ...
    this.gaugeCanvas.drawRect({
        ...
        x: this.getPointXY(-114, 1.1).x,
        y: this.getPointXY(-114, 1.1).y,
        width: 3,
        height: 22,
        rotate: -114
    }).drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-108, 1.1).x,
        y: this.getPointXY(-108, 1.1).y,
        width: 3,
        height: 22,
        rotate: -108
    }).drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-102, 1.1).x,
        y: this.getPointXY(-102, 1.1).y,
        width: 3,
        height: 22,
        rotate: -102
    }).drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-96, 1.1).x,
        y: this.getPointXY(-96, 1.1).y,
        width: 3,
        height: 22,
        rotate: -96
    });
    ...
    this.gaugeCanvas.drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-84, 1.1).x,
        y: this.getPointXY(-84, 1.1).y,
        width: 3,
        height: 22,
        rotate: -84
    }).drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-78, 1.1).x,
        y: this.getPointXY(-78, 1.1).y,
        width: 3,
        height: 22,
        rotate: -78
    }).drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-72, 1.1).x,
        y: this.getPointXY(-72, 1.1).y,
        width: 3,
        height: 22,
        rotate: -72
    }).drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-66, 1.1).x,
        y: this.getPointXY(-66, 1.1).y,
        width: 3,
        height: 22,
        rotate: -66
    });
    ...
    this.gaugeCanvas.drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-54, 1.1).x,
        y: this.getPointXY(-54, 1.1).y,
        width: 3,
        height: 22,
        rotate: -54
    }).drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-48, 1.1).x,
        y: this.getPointXY(-48, 1.1).y,
        width: 3,
        height: 22,
        rotate: -48
    }).drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-42, 1.1).x,
        y: this.getPointXY(-42, 1.1).y,
        width: 3,
        height: 22,
        rotate: -42
    }).drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-36, 1.1).x,
        y: this.getPointXY(-36, 1.1).y,
        width: 3,
        height: 22,
        rotate: -36
    });
    ...
    this.gaugeCanvas.drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-24, 1.1).x,
        y: this.getPointXY(-24, 1.1).y,
        width: 3,
        height: 22,
        rotate: -24
    }).drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-18, 1.1).x,
        y: this.getPointXY(-18, 1.1).y,
        width: 3,
        height: 22,
        rotate: -18
    }).drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-12, 1.1).x,
        y: this.getPointXY(-12, 1.1).y,
        width: 3,
        height: 22,
        rotate: -12
    }).drawRect({
        ...
        strokeStyle: this.gaugeConfig.mainSmallIndColor,
        fillStyle: this.gaugeConfig.mainSmallIndColor,
        x: this.getPointXY(-6, 1.1).x,
        y: this.getPointXY(-6, 1.1).y,
        width: 3,
        height: 22,
        rotate: -6
    });
    ...
    this.gaugeCanvas.drawText({ // 0
        ...
        strokeWidth: 1,
        x: this.getPointXY(-120, 1.235).x,
        y: this.getPointXY(-120, 1.235).y,
        fontSize: '44',
        ...
        fillStyle: this.gaugeConfig.mainTextColor,
        strokeWidth: 1,
        x: this.getPointXY(-90, 1.235).x,
        y: this.getPointXY(-90, 1.235).y,
        fontSize: '44',
        fontFamily: this.gaugeConfig.fontFamily,
        text: '5'
    }).drawText({ // 5
        ...
        fillStyle: this.gaugeConfig.mainTextColor,
        strokeWidth: 1,
        x: this.getPointXY(-60, 1.235).x,
        y: this.getPointXY(-60, 1.235).y,
        fontSize: '44',
        fontFamily: this.gaugeConfig.fontFamily,
        text: '10'
    }).drawText({ // 10
        ...
        fillStyle: this.gaugeConfig.mainTextColor,
        strokeWidth: 1,
        x: this.getPointXY(-30, 1.255).x,
        y: this.getPointXY(-30, 1.255).y,
        fontSize: '44',
        fontFamily: this.gaugeConfig.fontFamily,
        text: '25'
    }).drawText({ // 25
        ...
        fillStyle: this.gaugeConfig.mainTextColor,
        strokeWidth: 1,
        x: this.getPointXY(0, 1.245).x,
        y: this.getPointXY(0, 1.245).y,
        fontSize: '44',
        fontFamily: this.gaugeConfig.fontFamily,
        text: '50'
    }).drawText({ // 50
        ...
        fillStyle: this.gaugeConfig.mainTextColor,
        strokeWidth: 1,
        x: this.getPointXY(60, 1.290).x,
        y: this.getPointXY(60, 1.290).y,
        fontSize: '44',
        fontFamily: this.gaugeConfig.fontFamily,
        text: '250'
    }).drawText({ // 250
        ...
        fillStyle: this.gaugeConfig.mainTextColor,
        strokeWidth: 1,
        x: this.getPointXY(85, 1.290).x,
        y: this.getPointXY(90, 1.290).y,
        fontSize: '44',
        fontFamily: this.gaugeConfig.fontFamily,
        text: '500'
    }).drawText({ // 500
        ...
        fillStyle: this.gaugeConfig.mainTextColor,
        strokeWidth: 1,
        x: this.getPointXY(115, 1.295).x,
        y: this.getPointXY(120, 1.245).y,
        fontSize: '44',
        fontFamily: this.gaugeConfig.fontFamily,
        text: '1000'
    });
    ...
    this.gaugeCanvas.drawRect({ // 0
        ...
        x: this.getPointXY(-120, 1.125).x,
        y: this.getPointXY(-120, 1.125).y,
        width: 4,
        height: 39,
        rotate: -120
    }).drawRect({ // 2
        ...
        strokeStyle: this.gaugeConfig.mainBigIndColor,
        fillStyle: this.gaugeConfig.mainBigIndColor,
        x: this.getPointXY(-90, 1.125).x,
        y: this.getPointXY(-90, 1.125).y,
        width: 4,
        height: 39,
        rotate: -90
    }).drawRect({ // 5
        ...
        strokeStyle: this.gaugeConfig.mainBigIndColor,
        fillStyle: this.gaugeConfig.mainBigIndColor,
        x: this.getPointXY(-60, 1.125).x,
        y: this.getPointXY(-60, 1.125).y,
        width: 4,
        height: 39,
        rotate: -60
    }).drawRect({ // 10
        ...
        strokeStyle: this.gaugeConfig.mainBigIndColor,
        fillStyle: this.gaugeConfig.mainBigIndColor,
        x: this.getPointXY(-30, 1.125).x,
        y: this.getPointXY(-30, 1.125).y,
        width: 4,
        height: 39,
        rotate: -30
    }).drawRect({ // 25
        ...
        strokeStyle: this.gaugeConfig.mainBigIndColor,
        fillStyle: this.gaugeConfig.mainBigIndColor,
        x: this.getPointXY(0, 1.125).x,
        y: this.getPointXY(0, 1.125).y,
        width: 4,
        height: 39,
        rotate: 0
    }).drawRect({ // 50
...
fireProbeGraphic.prototype.initPhase = function(action) {
    switch (action) {
        case 'latency':
            ...
            this.tween = TweenLite.to($('#fireprobe .progress .progress-bar'), this.sp.configuration['latencyTime'], {
                css: {
                    width: '100%'
                }
            });
        ...
        case 'download':
            ...
            this.tween = TweenLite.to($('#fireprobe .progress .progress-bar'), this.sp.configuration['downloadTime'], {
                css: {
                    width: '100%'
                }
            });
        ...
        case 'upload':
            ...
            this.tween = TweenLite.to($('#fireprobe .progress .progress-bar'), this.sp.configuration['uploadTime'], {
                css: {
                    width: '100%'
                }
            });
