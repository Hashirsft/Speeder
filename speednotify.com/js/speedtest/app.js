/*! For license information please see app.js.LICENSE.txt */ ! function(e) {
            ...
            function(e) {
                ...
                function q() {
                    if (!this.state.isDestroyed) {
                        ...
                        e.offsets.reference = M(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = L(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = P(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = R(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                    }
                }
                        ...
                        modifiers: {
                            ...
                            arrow: {
                                ...
                                fn: function(e, t) {
                                    ...
                                    var i = e.placement.split("-")[0],
                                        ...
                                        p = c ? "bottom" : "right",
                                        m = I(r)[u];
                                    l[p] - m < s[d] && (e.offsets.popper[d] -= s[d] - (l[p] - m)), l[d] + m > s[p] && (e.offsets.popper[d] += l[d] + m - s[p]), e.offsets.popper = C(e.offsets.popper);
                                    var g = l[d] + l[u] / 2 - m / 2,
                                        v = a(e.instance.popper),
                                        b = parseFloat(v["margin" + f]),
                                        y = parseFloat(v["border" + f + "Width"]),
                                        w = g - e.offsets.popper[d] - b - y;
                                    return w = Math.max(Math.min(s[u] - m, w), 0), e.arrowElement = r, e.offsets.arrow = (E(n = {}, d, Math.round(w)), E(n, h, ""), n), e
                                },
                                element: "[x-arrow]"
                            },
                            flip: {
                                ...
                                fn: function(e, t) {
                                    ...
                                    return a.forEach((function(s, l) {
                                        ...
                                        var c = e.offsets.popper,
                                            ...
                                            y = !!t.flipVariations && (b && "start" === o && h || b && "end" === o && p || !b && "start" === o && m || !b && "end" === o && g),
                                            w = !!t.flipVariationsByContent && (b && "start" === o && p || b && "end" === o && h || !b && "start" === o && g || !b && "end" === o && m),
                                            _ = y || w;
                                        (d || v || _) && (e.flipped = !0, (d || v) && (r = a[l + 1]), _ && (o = function(e) {
                                            return "end" === e ? "start" : "start" === e ? "end" : e
                                        }(o)), e.placement = r + (o ? "-" + o : ""), e.offsets.popper = T({}, e.offsets.popper, P(e.instance.popper, e.offsets.reference, e.placement)), e = R(e.instance.modifiers, e, "flip"))
                                    })), e
                                },
                                behavior: "flip",
                                padding: 5,
                            ...
                            inner: {
                                ...
                                fn: function(e) {
                                    ...
                                    return i[a ? "left" : "top"] = o[n] - (s ? i[a ? "width" : "height"] : 0), e.placement = H(t), e.offsets.popper = C(i), e
                                }
                            },
                            hide: {
                                order: 800,
    ...
    2: function(e, t, n) {
        ...
        (function(e, r) {
            ...
            var m = (f.navigator || {}).userAgent,
                ...
                y = h,
                w = p,
                _ = (v.document, !!b.documentElement && !!b.head && "function" == typeof b.addEventListener && "function" == typeof b.createElement),
                ...
                S = /Font Awesome ([5 ]*)(Solid|Regular|Light|Duotone|Brands|Free|Pro|Kit).*/,
                N = {
                    900: "fas",
                    400: "far",
                    normal: "far",
                ...
                L = ["xs", "sm", "lg", "fw", "ul", "li", "border", "pull-left", "pull-right", "spin", "pulse", "rotate-90", "rotate-180", "rotate-270", "flip-horizontal", "flip-vertical", "flip-both", "stack", "stack-1x", "stack-2x", "inverse", "layers", "layers-text", "layers-counter", j.GROUP, j.SWAP_OPACITY, j.PRIMARY, j.SECONDARY].concat(A.map((function(e) {
                    return "".concat(e, "x")
                }))).concat(D.map((function(e) {
                    return "w-".concat(e)
                }))),
                M = v.FontAwesomeConfig || {};
            ...
            var z = P.___FONT_AWESOME___,
                R = [],
                q = !1;

            function F(e) {
                _ && (q ? setTimeout(e, 0) : R.push(e))
            }
            _ && ((q = (b.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(b.readyState)) || b.addEventListener("DOMContentLoaded", (function e() {
                b.removeEventListener("DOMContentLoaded", e), q = 1, R.map((function(e) {
                    return e()
                }))
            })));
            var B, W = function() {},
                V = void 0 !== e && void 0 !== e.process && "function" == typeof e.process.emit,
                U = void 0 === r ? setTimeout : r,
                $ = [];

            function Q() {
                for (var e = 0; e < $.length; e++) $[e][0]($[e][1]);
                $ = [], B = !1
            }

            function Y(e, t) {
                $.push([e, t]), B || (B = !0, U(Q, 0))
            }
            ...
            function X(e) {
                ...
                K(o, r) || ("fulfilled" === n && G(o, r), "rejected" === n && Z(o, r))
            }
            ...
            function J(e, t) {
                "pending" === e._state && (e._state = "settled", e._data = t, Y(te, e))
            }

            function Z(e, t) {
                "pending" === e._state && (e._state = "settled", e._data = t, Y(ne, e))
            }
            ...
            function te(e) {
                e._state = "fulfilled", ee(e)
            }

            function ne(t) {
                t._state = "rejected", ee(t), !t._handled && V && e.process.emit("unhandledRejection", t._data, t)
            }
            ...
            function ie(e) {
                ...
                if (this instanceof ie == !1) throw new TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.");
                this._then = [],
                    function(e, t) {
                        function n(e) {
                            Z(t, e)
            ...
            ie.prototype = {
                ...
                then: function(e, t) {
                    ...
                    return !t && !e || this._handled || (this._handled = !0, "rejected" === this._state && V && Y(re, this)), "fulfilled" === this._state || "rejected" === this._state ? Y(X, n) : this._then.push(n), n.then
                },
                catch: function(e) {
                ...
                return e && "object" === i(e) && e.constructor === ie ? e : new ie((function(t) {
                    t(e)
                }))
            ...
            var oe = "function" == typeof Promise ? Promise : ie,
                ae = 16,
                se = {
                    size: 16,
                    x: 0,
            ...
            function fe(e) {
                return e.classList ? ue(e.classList) : (e.getAttribute("class") || "").split(" ").filter((function(e) {
                    return e
                }))
            }
            ...
            function de(e, t) {
                var n, r = t.split("-"),
                    i = r[0],
                    o = r.slice(1).join("-");
                return i !== e || "" === o || (n = o, ~L.indexOf(n)) ? null : o
            }
            ...
            function ye(e) {
                var t = e.icons,
                    ...
                    w = [H.replacementClass, o ? "".concat(H.familyPrefix, "-").concat(o) : "", y].filter((function(e) {
                ...
                p && (_.attributes["data-fa-i2svg"] = ""), c && _.children.push({
                    tag: "title",
                    attributes: {
                        id: _.attributes["aria-labelledby"] || "title-".concat(f || ce())
                    },
                    children: [c]
                });
                var E = s({}, _, {
                    ...
                    T = r.found && n.found ? function(e) {
                        var t, n = e.children,
                            ...
                            g = {
                                ...
                                children: [be(s({
                                    tag: u.tag,
                                    attributes: s({}, u.attributes, h.path)
                                }, m))]
                            },
                            v = {
                                tag: "g",
                    ...
                    C = T.children,
                    k = T.attributes;
                return E.children = C, E.attributes = k, l ? function(e) {
                    var t = e.prefix,
                        n = e.iconName,
                        r = e.children,
                        i = e.attributes,
                    ...
                    return [{
                        ...
                        children: [{
                            tag: "symbol",
                            attributes: s({}, i, {
                                id: !0 === o ? "".concat(t, "-").concat(H.familyPrefix, "-").concat(n) : o
                            }),
                            children: r
                        }]
                    }]
            ...
            function we(e) {
                ...
                me(i) && (f.transform = function(e) {
                    var t = e.transform,
                        ...
                        s = void 0 !== a && a,
                        l = "";
                    return l += s && x ? "translate(".concat(t.x / ae - r / 2, "em, ").concat(t.y / ae - o / 2, "em) ") : s ? "translate(calc(-50% + ".concat(t.x / ae, "em), calc(-50% + ").concat(t.y / ae, "em)) ") : "translate(".concat(t.x / ae, "em, ").concat(t.y / ae, "em) "), l += "scale(".concat(t.size / ae * (t.flipX ? -1 : 1), ", ").concat(t.size / ae * (t.flipY ? -1 : 1), ") "), l += "rotate(".concat(t.rotate, "deg) ")
                }({
                    transform: i,
                    startCentered: !0,
                    width: n,
            ...
            var xe = function() {},
                Ee = H.measurePerformance && w && w.mark && w.measure ? w : {
                    mark: xe,
                    measure: xe
                },
                Te = 'FA "5.15.3"',
                Ce = function(e) {
                    Ee.mark("".concat(Te, " ").concat(e, " ends")), Ee.measure("".concat(Te, " ").concat(e), "".concat(Te, " ").concat(e, " begins"), "".concat(Te, " ").concat(e, " ends"))
                },
                ke = function(e) {
                    return Ee.mark("".concat(Te, " ").concat(e, " begins")),
                        function() {
                            return Ce(e)
                        }
                },
            ...
            function Ae(e, t) {
                ...
                "function" != typeof z.hooks.addPack || i ? z.styles[e] = s({}, z.styles[e] || {}, o) : z.hooks.addPack(e, o), "fas" === e && Ae("fa", t)
            }
            var De = z.styles,
                Oe = z.shims,
                je = {},
            ...
            function ze(e) {
                return e.reduce((function(e, t) {
                    var n = de(H.familyPrefix, t);
                    if (Pe[t]) e.prefix = t;
                    else if (H.autoFetchSvg && Object.keys(C).indexOf(t) > -1) e.prefix = t;
                    else if (n) {
                        var r = "fa" === e.prefix ? Me[n] || {
                            prefix: null,
                            iconName: null
                        } : {};
                        e.iconName = r.iconName || n, e.prefix = r.prefix || e.prefix
                    } else t !== H.replacementClass && 0 !== t.indexOf("fa-w-") && e.rest.push(t);
                    return e
                }), {
                    prefix: null,
                    iconName: null,
            ...
            function qe(e) {
                ...
                }(r), ">").concat(o.map(qe).join(""), "</").concat(t, ">")
            }
            var Fe = function() {};
            ...
            var We = {
                replace: function(e) {
                    ...
                    if (t.parentNode && t.outerHTML) t.outerHTML = n + (H.keepOriginalSource && "svg" !== t.tagName.toLowerCase() ? "\x3c!-- ".concat(t.outerHTML, " Font Awesome fontawesome.com --\x3e") : "");
                ...
                nest: function(e) {
                    var t = e[0],
                        n = e[1];
                    if (~fe(t).indexOf(H.replacementClass)) return We.replace(e);
            ...
            function Ue(e, t) {
                var n = "function" == typeof t ? t : Fe;
                if (0 === e.length) n();
                else {
                    var r = Ve;
                    "async" === H.mutateApproach && (r = v.requestAnimationFrame || Ve), r((function() {
                        var t = !0 === H.autoReplaceSvg ? We.replace : We[H.autoReplaceSvg] || We.replace,
                            r = ke("mutate");
                        e.map(t), r(), n()
                    }))
                }
            ...
            function Xe(e) {
                if (y && H.observeMutations) {
                    var t = e.treeCallback,
                        ...
                        o = void 0 === i ? b : i;
                    Ye = new y((function(e) {
                        $e || ue(e).forEach((function(e) {
                            if ("childList" === e.type && e.addedNodes.length > 0 && !Be(e.addedNodes[0]) && (H.searchPseudoElements && r(e.target), t(e.target)), "attributes" === e.type && e.target.parentNode && H.searchPseudoElements && r(e.target.parentNode), "attributes" === e.type && Be(e.target) && ~O.indexOf(e.attributeName))
                                if ("class" === e.attributeName) {
                                    var i = ze(fe(e.target)),
                                        o = i.prefix,
                                        a = i.iconName;
            ...
            function Ke(e) {
                var t, n, r = e.getAttribute("data-prefix"),
                    ...
                    a = ze(fe(e));
                return r && i && (a.prefix = r, a.iconName = i), a.prefix && o.length > 1 ? a.iconName = (t = a.prefix, n = e.innerText, (Le[t] || {})[n]) : a.prefix && 1 === o.length && (a.iconName = He(a.prefix, Ne(e.innerText))), a
            }
            var Ge = function(e) {
                var t = {
                    size: 16,
            ...
            function Je(e) {
                var t = Ke(e),
                    ...
                    a = function(e) {
                        return Ge(e.getAttribute("data-fa-transform"))
                    }(e),
                    s = function(e) {
                    ...
                    l = function(e) {
                        var t = ue(e.attributes).reduce((function(e, t) {
                                return "class" !== e.name && "style" !== e.name && (e[t.name] = t.value), e
                            }), {}),
                            n = e.getAttribute("title"),
                            r = e.getAttribute("data-fa-title-id");
                        return H.autoA11y && (n ? t["aria-labelledby"] = "".concat(H.replacementClass, "-title-").concat(r || ce()) : (t["aria-hidden"] = "true", t.focusable = "false")), t
                    }(e),
                    c = function(e) {
                        var t = e.getAttribute("data-fa-mask");
                        return t ? ze(t.split(" ").map((function(e) {
                            return e.trim()
                        }))) : {
                            prefix: null,
                            iconName: null,
            ...
            function at(e) {
                ...
                return {
                    ...
                    icon: Array.isArray(r) ? {
                        tag: "g",
                        attributes: {
                            class: "".concat(H.familyPrefix, "-").concat(j.GROUP)
                        },
                        children: [{
                            tag: "path",
                            attributes: {
                                class: "".concat(H.familyPrefix, "-").concat(j.SECONDARY),
                                fill: "currentColor",
                                d: r[0]
                            }
                        }, {
                            tag: "path",
                            attributes: {
                                class: "".concat(H.familyPrefix, "-").concat(j.PRIMARY),
                                fill: "currentColor",
                                d: r[1]
                            }
                        }]
            ...
            function st(e, t) {
                return new oe((function(n, r) {
                    ...
                    if (e && t && ot[t] && ot[t][e]) return n(at(ot[t][e]));
                    e && t && !H.showMissingIcons ? r(new Ze("Icon is missing for prefix ".concat(t, " with icon name ").concat(e))) : n(i)
                }))
            }
            var lt = z.styles;
            ...
            function ct(e) {
                var t = Je(e);
                return ~t.extra.classes.indexOf("fa-layers-text") ? function(e, t) {
                    var n = t.title,
                        r = t.transform,
                        i = t.extra,
                        o = null,
                    ...
                    return H.autoA11y && !n && (i.attributes["aria-hidden"] = "true"), oe.resolve([e, we({
                        content: e.innerHTML,
                        width: o,
                        height: a,
                        transform: r,
                    ...
                    var n = t.iconName,
                        ...
                        u = t.maskId,
                        f = t.extra;
                    return new oe((function(t, d) {
                        oe.all([st(n, o), st(c.iconName, c.prefix)]).then((function(c) {
                            var d = l(c, 2),
                                h = d[0],
                                p = d[1];
                            t([e, ye({
            ...
            function ut(e) {
                ...
                if (_) {
                    var n = b.documentElement.classList,
                        ...
                        o = H.autoFetchSvg ? Object.keys(C) : Object.keys(lt),
                        a = [".".concat("fa-layers-text", ":not([").concat("data-fa-i2svg", "])")].concat(o.map((function(e) {
                            return ".".concat(e, ":not([").concat("data-fa-i2svg", "])")
                        }))).join(", ");
                    if (0 !== a.length) {
                        var s = [];
                        try {
                            s = ue(e.querySelectorAll(a))
                        } catch (e) {}
                        if (s.length > 0) {
                            ...
                            var l = ke("onTree"),
                                c = s.reduce((function(e, t) {
                                    try {
                                        ...
                                        T || e instanceof Ze && console.error(e)
                                    }
                                    return e
                                }), []);
                            return new oe((function(e, n) {
                                oe.all(c).then((function(n) {
                                    Ue(n, (function() {
            ...
            function dt(e, t) {
                ...
                return new oe((function(r, i) {
                    if (null !== e.getAttribute(n)) return r();
                    var o = ue(e.children).filter((function(e) {
                            return e.getAttribute("data-fa-pseudo-element") === t
                        }))[0],
                        a = v.getComputedStyle(e, t),
                        l = a.getPropertyValue("font-family").match(S),
                    ...
                    if (l && "none" !== u && "" !== u) {
                        var f = a.getPropertyValue("content"),
                            d = ~["Solid", "Regular", "Light", "Duotone", "Brands", "Kit"].indexOf(l[2]) ? k[l[2].toLowerCase()] : N[c],
                            h = Ne(3 === f.length ? f.substr(1, 1) : f),
                            p = He(d, h),
                            m = p;
                        if (!p || o && o.getAttribute("data-prefix") === d && o.getAttribute("data-icon") === m) r();
                        else {
                            ...
                            var g = {
                                ...
                                y = g.extra;
                            y.attributes["data-fa-pseudo-element"] = t, st(p, d).then((function(i) {
                                var o = ye(s({}, g, {
                                        icons: {
                                            main: i,
                                            mask: {
            ...
            function ht(e) {
                return oe.all([dt(e, ":before"), dt(e, ":after")])
            }

            function pt(e) {
                return !(e.parentNode === document.head || ~E.indexOf(e.tagName.toUpperCase()) || e.getAttribute("data-fa-pseudo-element") || e.parentNode && "svg" === e.parentNode.tagName)
            }

            function mt(e) {
                if (_) return new oe((function(t, n) {
                    var r = ue(e.querySelectorAll("*")).filter(pt).map(ht),
                        i = ke("searchPseudoElements");
                    $e = !0, oe.all(r).then((function() {
                        i(), Qe(), t()
                    })).catch((function() {
                        i(), Qe(), n()
                    }))
            ...
            function yt(e) {
                var t = e.prefix,
                    n = void 0 === t ? "fa" : t,
                    r = e.iconName;
                if (r) return Re(_t.definitions, n, r) || Re(z.styles, n, r)
            }
            var wt, _t = new(function() {
                    function e() {
                        ! function(e, t) {
                            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    ...
                    return t = e, (n = [{
                        ...
                        value: function() {
                            ...
                            Object.keys(i).forEach((function(t) {
                                e.definitions[t] = s({}, e.definitions[t] || {}, i[t]), Ae(t, i[t]), Ie()
                            }))
                        }
                    }, {
                        key: "reset",
                ...
                Et = {
                    i2svg: function() {
                        ...
                        if (_) {
                            ...
                            return H.searchPseudoElements && mt(n), ut(n, i)
                        }
                        return oe.reject("Operation requires a DOM of some kind.")
                    },
                    css: gt,
                    insertCss: function() {
                        xt || (le(gt()), xt = !0)
                    ...
                    watch: function() {
                        ...
                        !1 === H.autoReplaceSvg && (H.autoReplaceSvg = !0), H.observeMutations = !0, F((function() {
                            St({
                                autoReplaceSvgRoot: t
                            }), Xe({
                                treeCallback: ut,
                                nodeCallback: ft,
                                pseudoElementsCallback: mt,
                ...
                Ct = (wt = function(e) {
                    ...
                    if (e) {
                        ...
                        return bt(s({
                            ...
                            return vt(), H.autoA11y && (d ? b["aria-labelledby"] = "".concat(H.replacementClass, "-title-").concat(p || ce()) : (b["aria-hidden"] = "true", b.focusable = "false")), ye({
                                icons: {
                                    main: at(E),
                                    mask: l ? at(l.icon) : {
                                        found: !1,
                    ...
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        n = (e || {}).icon ? e : yt(e || {}),
                        r = t.mask;
                    return r && (r = (r || {}).icon ? r : yt(r || {})), wt(n, s({}, t, {
                        mask: r
                    }))
                }),
                kt = {
                    noAuto: function() {
                        H.autoReplaceSvg = !1, H.observeMutations = !1, Ye && Ye.disconnect()
                    },
                    config: H,
                    dom: Et,
                    library: _t,
                        ...
                        return bt({
                            ...
                            return vt(), we({
                                ...
                                extra: {
                                    attributes: f,
                                    styles: h,
                                    classes: ["".concat(H.familyPrefix, "-layers-text")].concat(c(l))
                                }
                            })
                        }))
                    },
                        ...
                        return bt({
                            ...
                            return vt(), _e({
                                ...
                                extra: {
                                    attributes: s,
                                    styles: u,
                                    classes: ["".concat(H.familyPrefix, "-layers-counter")].concat(c(o))
                                }
                            })
                        }))
                    },
                    layer: function(e) {
                        ...
                        return bt({
                            ...
                            return e((function(e) {
                                ...
                                tag: "span",
                                attributes: {
                                    class: ["".concat(H.familyPrefix, "-layers")].concat(c(r)).join(" ")
                                },
                                children: t
                            }]
                        }))
                ...
                St = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        t = e.autoReplaceSvgRoot,
                        n = void 0 === t ? b : t;
                    (Object.keys(z.styles).length > 0 || H.autoFetchSvg) && _ && H.autoReplaceSvg && kt.dom.i2svg({
                        node: n
                    })
                }
    ...
    28: function(e, t, n) {
        try {
            window.$ = window.jQuery = n(6), window.Popper = n(13).default, n(29)
        } catch (e) {
            console.log(e)
        }
    },
    29: function(e, t, n) {
        ! function(e, t, n) {
            ...
            u.jQueryDetection(), i.default.fn.emulateTransitionEnd = c, i.default.event.special[u.TRANSITION_END] = {
            ...
            i.default(document).on("click.bs.button.data-api", '[data-toggle^="button"]', (function(e) {
                ...
                if (i.default(t).hasClass("btn") || (t = i.default(t).closest(".btn")[0]), !t || t.hasAttribute("disabled") || t.classList.contains("disabled")) e.preventDefault();
                    ...
                    "INPUT" !== n.tagName && "LABEL" === t.tagName || m._jQueryInterface.call(i.default(t), "toggle", "INPUT" === n.tagName)
                }
            ...
            })), i.default.fn.button = m._jQueryInterface, i.default.fn.button.Constructor = m, i.default.fn.button.noConflict = function() {
                return i.default.fn.button = p, m._jQueryInterface
            };
            var g = "carousel",
                v = ".bs.carousel",
                b = i.default.fn[g],
                ...
                x = function() {
                    ...
                    return t.next = function() {
                        ...
                        i.default(this._element).off(v), i.default.removeData(this._element, "bs.carousel"), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                    }, t._getConfig = function(e) {
                        return e = l({}, y, e), u.typeCheckConfig(g, e, w), e
            ...
            i.default(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", x._dataApiClickHandler), i.default(window).on("load.bs.carousel.data-api", (function() {
                ...
                return i.default.fn[g] = b, x._jQueryInterface
            };
            var E = "collapse",
                T = i.default.fn[E],
                C = {
                ...
                S = function() {
                    ...
                    return t.toggle = function() {
                        ...
                        return (e = l({}, C, e)).toggle = Boolean(e.toggle), u.typeCheckConfig(E, e, k), e
            ...
            })), i.default.fn[E] = S._jQueryInterface, i.default.fn[E].Constructor = S, i.default.fn[E].noConflict = function() {
            ...
            var N = "dropdown",
                ...
                L = function() {
                    ...
                    return t.toggle = function() {
                        ...
                        return e = l({}, this.constructor.Default, i.default(this._element).data(), e), u.typeCheckConfig(N, e, this.constructor.DefaultType), e
                            ...
                            for (var n = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), r = 0, o = n.length; r < o; r++) {
                                ...
                                if (t && "click" === t.type && (l.clickEvent = t), s) {
                                    ...
                                    if (i.default(a).hasClass("show") && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && i.default.contains(a, t.target))) {
                                        ...
                                        i.default(a).trigger(u), u.isDefaultPrevented() || ("ontouchstart" in document.documentElement && i.default(document.body).children().off("mouseover", null, i.default.noop), n[r].setAttribute("aria-expanded", "false"), s._popper && s._popper.destroy(), i.default(c).removeClass("show"), i.default(a).removeClass("show").trigger(i.default.Event("hidden.bs.dropdown", l)))
                                    }
                                }
                            }
                        ...
                        if (!(/input|textarea/i.test(t.target.tagName) ? 32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || i.default(t.target).closest(".dropdown-menu").length) : !D.test(t.which)) && !this.disabled && !i.default(this).hasClass("disabled")) {
            ...
            i.default(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', L._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", L._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", L._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', (function(e) {
                e.preventDefault(), e.stopPropagation(), L._jQueryInterface.call(i.default(this), "toggle")
            })).on("click.bs.dropdown.data-api", ".dropdown form", (function(e) {
                e.stopPropagation()
            })), i.default.fn[N] = L._jQueryInterface, i.default.fn[N].Constructor = L, i.default.fn[N].noConflict = function() {
                return i.default.fn[N] = A, L._jQueryInterface
            };
            var M = i.default.fn.modal,
                I = {
                    backdrop: !0,
                    keyboard: !0,
                    focus: !0,
                ...
                P = function() {
                    ...
                    return t.toggle = function(e) {
                        ...
                        return e = l({}, I, e), u.typeCheckConfig("modal", e, H), e
                        ...
                        return this.each((function() {
                            var r = i.default(this).data("bs.modal"),
                                o = l({}, I, i.default(this).data(), "object" == typeof t && t ? t : {});
            ...
            i.default(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', (function(e) {
                ...
                return i.default.fn.modal = M, P._jQueryInterface
            };
                ...
                for (var r = (new window.DOMParser).parseFromString(e, "text/html"), i = Object.keys(t), o = [].slice.call(r.body.querySelectorAll("*")), a = function(e, n) {
                        ...
                        s.forEach((function(e) {
                            (function(e, t) {
                                ...
                                if (-1 !== t.indexOf(n)) return -1 === z.indexOf(n) || Boolean(e.nodeValue.match(q) || e.nodeValue.match(F));
            ...
            var W = "tooltip",
                ...
                G = function() {
                    ...
                    return t.enable = function() {
                        ...
                        "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = B(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t)) : e.text(t) : this.config.html ? i.default(t).parent().is(e) || e.empty().append(t) : e.text(i.default(t).text())
                    }, t.getTitle = function() {
                        ...
                        return Object.keys(t).forEach((function(e) {
                            ...
                            show: e.delay,
                            hide: e.delay
                        }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), u.typeCheckConfig(W, e, this.constructor.DefaultType), e.sanitize && (e.template = B(e.template, e.whiteList, e.sanitizeFn)), e
            ...
            i.default.fn[W] = G._jQueryInterface, i.default.fn[W].Constructor = G, i.default.fn[W].noConflict = function() {
                return i.default.fn[W] = V, G._jQueryInterface
            };
            var J = "popover",
                Z = i.default.fn[J],
            ...
            i.default.fn[J] = ie._jQueryInterface, i.default.fn[J].Constructor = ie, i.default.fn[J].noConflict = function() {
                ...
                ce = function() {
                    ...
                    return t.refresh = function() {
                        ...
                        this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map((function(e) {
                            var t, o = u.getSelectorFromElement(e);
                        ...
                        if ("string" != typeof(e = l({}, se, "object" == typeof e && e ? e : {})).target && u.isElement(e.target)) {
                            var t = i.default(e.target).attr("id");
                            t || (t = u.getUID(oe), i.default(e.target).attr("id", t)), e.target = "#" + t
                        }
            ...
            })), i.default.fn[oe] = ce._jQueryInterface, i.default.fn[oe].Constructor = ce, i.default.fn[oe].noConflict = function() {
                return i.default.fn[oe] = ae, ce._jQueryInterface
            };
            var ue = i.default.fn.tab,
                fe = function() {
                    function e(e) {
                        this._element = e
                    }
            ...
            })), i.default.fn.tab = fe._jQueryInterface, i.default.fn.tab.Constructor = fe, i.default.fn.tab.noConflict = function() {
                return i.default.fn.tab = ue, fe._jQueryInterface
            };
            var de = i.default.fn.toast,
                ...
                me = function() {
                    ...
                    return t.show = function() {
                        ...
                        return e = l({}, pe, i.default(this._element).data(), "object" == typeof e && e ? e : {}), u.typeCheckConfig("toast", e, this.constructor.DefaultType), e
                    }, t._setListeners = function() {
                        var e = this;
            ...
            i.default.fn.toast = me._jQueryInterface, i.default.fn.toast.Constructor = me, i.default.fn.toast.noConflict = function() {
                return i.default.fn.toast = de, me._jQueryInterface
            }, e.Alert = h, e.Button = m, e.Carousel = x, e.Collapse = S, e.Dropdown = L, e.Modal = P, e.Popover = ie, e.Scrollspy = ce, e.Tab = fe, e.Toast = me, e.Tooltip = G, e.Util = u, Object.defineProperty(e, "__esModule", {
                value: !0
            })
        }(t, n(6), n(13))
    },
    ...
    33: function(e, t, n) {
        ...
        function y(e, t) {
            ...
            if (t.singleton) {
                var a = u++;
                n = c || (c = v(t)), r = x.bind(null, n, a, !1), i = x.bind(null, n, a, !0)
            ...
            }) : (n = v(t), r = E.bind(null, n), i = function() {
                g(n)
            });
            return r(e),
                function(t) {
    ...
    35: function(e, t, n) {
        ...
        r(document).ready((function() {
            r("[data-onclick-copy]").click((function() {
                var e = r(this);
                void 0 !== e.attr("data-popover-placement") && e.attr("data-popover-placement"), void 0 !== e.attr("data-onclick-copy-text") && e.attr("data-onclick-copy-text");
                var t = document.createElement("textarea");
                t.value = e.attr("data-onclick-copy-data"), document.body.appendChild(t), t.select(), document.execCommand("copy"), document.body.removeChild(t), e.addClass("data-balloon-visible"), clearTimeout(e.balloonTimeout), e.balloonTimeout = setTimeout((function() {
                    e.removeClass("data-balloon-visible")
                }), 1e3)
            }));
            var e = r(".is-invalid, .invalid-feedback, .flash-message").first();
            if (e.length > 0) {
                var t = r(document).scrollTop(),
                    n = r(window).height() + r(document).scrollTop();
                (t > e.offset().top - 70 || n < e.first().offset().top) && r("html, body").animate({
                    scrollTop: e.first().offset().top - 70
                }, "slow")
            }
            r('[href^="#"]').click((function(e) {
                var t = '[data-anchor="' + r(this).attr("href").substring(1) + '"]',
                    n = r(t).first();
                if (console.log(t), n.length > 0) {
                    var i = r(t).attr("data-offset");
                    void 0 === i && (i = 70);
                    var o = r(document).scrollTop(),
                        a = r(window).height() + r(document).scrollTop();
                    (o > n.offset().top - i || a < n.first().offset().top) && r("html, body").animate({
                        scrollTop: n.first().offset().top - i
                    }, "slow")
                }
            }))
        }))
    ...
    36: function(e, t, n) {
        var r = n(6);
        r(document).ready((function() {
            r("[data-popup]").click((function() {
                var e = r(this).attr("data-popup");
                window.open(e, "window", "left=50,top=50,width=600,height=350,toolbar=0")
            }))
        }))
    },
    37: function(e, t, n) {
        var r = n(6);
        r(document).ready((function() {
            r("body").append('<div class="hide-on-landscape" id="portrait-indicator" style="height:0"></div>'), r("[data-scale]").each((function() {
                var e, t = r(this);
                void 0 !== t.attr("data-scale-attr") && (e = t.attr("data-scale-attr").split(","));
                var n = t.attr("data-scale-src"),
                    i = function() {
                        var i = parseFloat(t.attr("data-scale")),
                            o = t.attr("data-scale-unit") || "px",
                            a = i;
                        void 0 !== t.attr("data-scale-portrait") && (a = parseFloat(t.attr("data-scale-portrait")));
                        var s = r("#portrait-indicator").is(":visible"),
                            l = i * (r(n).width() / 100);
                        s && (l = a * (r(n).width() / 100)), "transform-scale" !== o ? e.forEach((function(e) {
                            t.css(e, l + o)
                        })) : t.css("transform", "scale(" + l + ")")
                    };
                r(window).on("resize", (function() {
                    i()
                })), r("body").on("fireprobe_rescale", (function() {
                    i()
                })), i()
            }))
        }))
    ...
    6: function(e, t, n) {
        ...
        ! function(t, n) {
            ...
            var C = function(e) {
                var t, n, r, i, o, a, s, l, c, u, f, d, h, p, m, g, v, b, y, w = "sizzle" + 1 * new Date,
                    _ = e.document,
                    x = 0,
                    E = 0,
                    T = le(),
                ...
                try {
                    L.apply(D = M.call(_.childNodes), _.childNodes), D[_.childNodes.length].nodeType
                } catch (e) {
                    L = {
                ...
                function se(e, t, r, i) {
                    var o, s, c, u, f, p, v, b = t && t.ownerDocument,
                        _ = t ? t.nodeType : 9;
                    ...
                    if (!i && (d(t), t = t || h, m)) {
                        ...
                        if (n.qsa && !S[e + " "] && (!g || !g.test(e)) && (1 !== _ || "object" !== t.nodeName.toLowerCase())) {
                            if (v = e, b = t, 1 === _ && (U.test(e) || V.test(e))) {
                                for ((b = ee.test(e) && ve(t.parentNode) || t) === t && n.scope || ((u = t.getAttribute("id")) ? u = u.replace(re, ie) : t.setAttribute("id", u = w)), s = (p = a(e)).length; s--;) p[s] = (u ? "#" + u : ":scope") + " " + ye(p[s]);
                                v = p.join(",")
                            }
                            try {
                ...
                for (t in n = se.support = {}, o = se.isXML = function(e) {
                        ...
                        return a != h && 9 === a.nodeType && a.documentElement ? (p = (h = a).documentElement, m = !o(h), _ != h && (i = h.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", oe, !1) : i.attachEvent && i.attachEvent("onunload", oe)), n.scope = ue((function(e) {
                            ...
                            var t;
                            p.appendChild(e).innerHTML = "<a id='" + w + "'></a><select id='" + w + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && g.push("[*^$]=" + P + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || g.push("\\[" + P + "*(?:value|" + H + ")"), e.querySelectorAll("[id~=" + w + "-]").length || g.push("~="), (t = h.createElement("input")).setAttribute("name", ""), e.appendChild(t), e.querySelectorAll("[name='']").length || g.push("\\[" + P + "*name" + P + "*=" + P + "*(?:''|\"\")"), e.querySelectorAll(":checked").length || g.push(":checked"), e.querySelectorAll("a#" + w + "+*").length || g.push(".#.+[+~]"), e.querySelectorAll("\\\f"), g.push("[\\r\\n\\f]")
                        })), ue((function(e) {
                        ...
                        })), g = g.length && new RegExp(g.join("|")), v = v.length && new RegExp(v.join("|")), t = J.test(p.compareDocumentPosition), y = t || J.test(p.contains) ? function(e, t) {
                            ...
                            return r || (1 & (r = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === r ? e == h || e.ownerDocument == _ && y(_, e) ? -1 : t == h || t.ownerDocument == _ && y(_, t) ? 1 : u ? I(u, e) - I(u, t) : 0 : 4 & r ? -1 : 1)
                        } : function(e, t) {
                            if (e === t) return f = !0, 0;
                            var n, r = 0,
                                i = e.parentNode,
                                ...
                                a = [e],
                                s = [t];
                            if (!i || !o) return e == h ? -1 : t == h ? 1 : i ? -1 : o ? 1 : u ? I(u, e) - I(u, t) : 0;
                                ...
                                return 1 === r && 0 === i ? function(e) {
                                    ...
                                    if (g) {
                                        ...
                                        if (p = [a ? g.firstChild : g.lastChild], a && b) {
                                            for (y = (h = (c = (u = (f = (d = g)[w] || (d[w] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === x && c[1]) && c[2], d = h && g.childNodes[h]; d = ++h && d && d[m] || (y = h = 0) || p.pop();)
                                                if (1 === d.nodeType && ++y && d === t) {
                                                    u[e] = [x, h, y];
                                                    break
                                                }
                                        } else if (b && (y = h = (c = (u = (f = (d = t)[w] || (d[w] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === x && c[1]), !1 === y)
                                            for (;
                                                (d = ++h && d && d[m] || (y = h = 0) || p.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++y || (b && ((u = (f = d[w] || (d[w] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [x, y]), d !== t)););
                ...
                function Ee(e, t, n, r, i, o) {
                    return r && !r[w] && (r = Ee(r)), i && !i[w] && (i = Ee(i, o)), ce((function(o, a, s, l) {
                        var c, u, f, d = [],
                            ...
                            v = n ? i || (o ? e : p || r) ? [] : a : g;
                        if (n && n(g, v, s, l), r)
                            for (c = xe(v, h), r(c, [], s, l), u = c.length; u--;)(f = c[u]) && (v[h[u]] = !(g[h[u]] = f));
                        if (o) {
                            if (i || e) {
                                if (i) {
                                ...
                                for (u = v.length; u--;)(f = v[u]) && (c = i ? I(o, f) : d[u]) > -1 && (o[c] = !(a[c] = f))
                            }
                    ...
                    for (var t, n, i, o = e.length, a = r.relative[e[0].type], s = a || r.relative[" "], l = a ? 1 : 0, u = we((function(e) {
                        ...
                        if (n = r.relative[e[l].type]) d = [we(_e(d), n)];
                            ...
                            if ((n = r.filter[e[l].type].apply(null, e[l].matches))[w]) {
                                ...
                                return Ee(l > 1 && _e(d), l > 1 && ye(e.slice(0, l - 1).concat({
                                    value: " " === e[l - 2].type ? "*" : ""
                                })).replace(B, "$1"), n, l < i && Te(e.slice(l, i)), i < o && Te(e = e.slice(i)), i < o && ye(e))
                            }
                            d.push(n)
                        }
                    return _e(d)
                            ...
                            var n = t.length > 0,
                                ...
                                o = function(o, a, s, l, u) {
                                    var f, p, g, v = 0,
                                        ...
                                        C = E.length;
                                    for (u && (c = a == h || a || u); b !== C && null != (f = E[b]); b++) {
                                        if (i && f) {
            ...
            (E.fn.init = function(e, t, n) {
                ...
                if (n = n || j, "string" == typeof e) {
                    ...
                    if (r[1]) {
                        if (t = t instanceof E ? t[0] : t, E.merge(this, E.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : y, !0)), D.test(r[1]) && E.isPlainObject(t))
                    ...
                    var t = [
                        ...
                        i = {
                            ...
                            then: function(e, r, i) {
                                        ...
                                        var s = this,
                                            ...
                                            c = function() {
                                                ...
                                                if (!(e < o)) {
                                                    ...
                                                    c = n && ("object" == typeof n || "function" == typeof n) && n.then, v(c) ? i ? c.call(n, a(o, t, z, i), a(o, t, R, i)) : (o++, c.call(n, a(o, t, z, i), a(o, t, R, i), a(o, t, z, t.notifyWith))) : (r !== z && (s = void 0, l = [n]), (i || t.resolveWith)(s, l))
                                                }
                                            },
                                            u = i ? c : function() {
                                                try {
                                                    ...
                                                    E.Deferred.exceptionHook && E.Deferred.exceptionHook(n, u.stackTrace), e + 1 >= o && (r !== R && (s = void 0, l = [n]), t.rejectWith(s, l))
                                                }
                                            };
                                ...
                                return E.Deferred((function(n) {
                                    t[0][3].add(a(0, n, v(i) ? i : z, n.notifyWith)), t[1][3].add(a(0, n, v(e) ? e : z)), t[2][3].add(a(0, n, v(r) ? r : R))
                                })).promise()
                            },
                            promise: function(e) {
            ...
            function W() {
                y.removeEventListener("DOMContentLoaded", W), n.removeEventListener("load", W), E.ready()
            }
            E.fn.ready = function(e) {
                ...
                readyWait: 1,
                ready: function(e) {
                    (!0 === e ? --E.readyWait : E.isReady) || (E.isReady = !0, !0 !== e && --E.readyWait > 0 || B.resolveWith(y, [E]))
                }
            }), E.ready.then = B.then, "complete" === y.readyState || "loading" !== y.readyState && !y.documentElement.doScroll ? n.setTimeout(E.ready) : (y.addEventListener("DOMContentLoaded", W), n.addEventListener("load", W));
            ...
            function fe(e) {
                var t, n = e.ownerDocument,
                    r = e.nodeName,
                    i = ue[r];
                return i || (t = n.body.appendChild(n.createElement(r)), i = E.css(t, "display"), t.parentNode.removeChild(t), "none" === i && (i = "block"), ue[r] = i, i)
            }
            ...
            function xe(e, t, n, r, i) {
                for (var o, a, s, l, c, u, f = t.createDocumentFragment(), d = [], h = 0, p = e.length; h < p; h++)
                    ...
                    for (a = a || f.appendChild(t.createElement("div")), s = (ge.exec(o) || ["", ""])[1].toLowerCase(), l = be[s] || be._default, a.innerHTML = l[1] + E.htmlPrefilter(o) + l[2], u = l[0]; u--;) a = a.lastChild;
                    E.merge(d, a.childNodes), (a = f.firstChild).textContent = ""
                } else d.push(t.createTextNode(o));
                for (f.textContent = "", h = 0; o = d[h++];)
                    if (r && E.inArray(o, r) > -1) i && i.push(o);
                    else if (c = ae(o), a = ye(f.appendChild(o), "script"), c && we(a), n)
            ...
            E.event = {
                ...
                add: function(e, t, n, r, i) {
                    var o, a, s, l, c, u, f, d, h, p, m, g = G.get(e);
                    if (X(e))
                        for (n.handler && (n = (o = n).handler, i = o.selector), i && E.find.matchesSelector(oe, i), n.guid || (n.guid = E.guid++), (l = g.events) || (l = g.events = Object.create(null)), (a = g.handle) || (a = g.handle = function(t) {
                                return void 0 !== E && E.event.triggered !== t.type ? E.event.dispatch.apply(e, arguments) : void 0
                            }), c = (t = (t || "").match(P) || [""]).length; c--;) h = m = (s = Ce.exec(t[c]) || [])[1], p = (s[2] || "").split(".").sort(), h && (f = E.event.special[h] || {}, h = (i ? f.delegateType : f.bindType) || h, f = E.event.special[h] || {}, u = E.extend({
                            type: h,
                            origType: m,
                            data: r,
                            handler: n,
                            ...
                            namespace: p.join(".")
                        }, o), (d = l[h]) || ((d = l[h] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, r, p, a) || e.addEventListener && e.addEventListener(h, a)), f.add && (f.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), i ? d.splice(d.delegateCount++, 0, u) : d.push(u), E.event.global[h] = !0)
                },
                remove: function(e, t, n, r, i) {
                    var o, a, s, l, c, u, f, d, h, p, m, g = G.hasData(e) && G.get(e);
                    if (g && (l = g.events)) {
                        for (c = (t = (t || "").match(P) || [""]).length; c--;)
                            if (h = m = (s = Ce.exec(t[c]) || [])[1], p = (s[2] || "").split(".").sort(), h) {
                                for (f = E.event.special[h] || {}, d = l[h = (r ? f.delegateType : f.bindType) || h] || [], s = s[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = d.length; o--;) u = d[o], !i && m !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || r && r !== u.selector && ("**" !== r || !u.selector) || (d.splice(o, 1), u.selector && d.delegateCount--, f.remove && f.remove.call(e, u));
                                a && !d.length && (f.teardown && !1 !== f.teardown.call(e, p, g.handle) || E.removeEvent(e, h, g.handle), delete l[h])
                            } else
                                for (h in l) E.event.remove(e, h + t[c], n, r, !0);
                    ...
                    if (l.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, l)) {
                        for (a = E.event.handlers.call(this, l, c), t = 0;
                            ...
                            for (l.currentTarget = i.elem, n = 0;
                                (o = i.handlers[n++]) && !l.isImmediatePropagationStopped();) l.rnamespace && !1 !== o.namespace && !l.rnamespace.test(o.namespace) || (l.handleObj = o, l.data = o.data, void 0 !== (r = ((E.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && !1 === (l.result = r) && (l.preventDefault(), l.stopPropagation()));
                ...
                special: {
                    ...
                    click: {
                        setup: function(e) {
                            var t = this || e;
                            return me.test(t.type) && t.click && A(t, "input") && De(t, "click", ke), !1
                        },
                        trigger: function(e) {
                            var t = this || e;
            ...
            function Re(e, t, n, r) {
                ...
                var i, o, a, s, c, u, f = 0,
                    ...
                    p = t[0],
                    m = v(p);
                if (m || d > 1 && "string" == typeof p && !g.checkClone && je.test(p)) return e.each((function(i) {
                    var o = e.eq(i);
                    m && (t[0] = p.call(this, i, o.html())), Re(o, t, n, r)
                }));
                if (d && (o = (i = xe(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
                    for (s = (a = E.map(ye(i, "script"), Ie)).length; f < d; f++) c = i, f !== h && (c = E.clone(c, !0, !0), s && E.merge(a, ye(c, "script"))), n.call(e[f], c, f);
                    if (s)
                        for (u = a[a.length - 1].ownerDocument, E.map(a, He), f = 0; f < s; f++) c = a[f], ve.test(c.type || "") && !G.access(c, "globalEval") && E.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? E._evalUrl && !c.noModule && E._evalUrl(c.src, {
            ...
            function qe(e, t, n) {
                for (var r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || E.cleanData(ye(r)), r.parentNode && (n && ae(r) && we(ye(r, "script")), r.parentNode.removeChild(r));
                return e
            }
            E.extend({
                ...
                clone: function(e, t, n) {
                    ...
                    if (!(g.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || E.isXMLDoc(e)))
                        for (a = ye(s), r = 0, i = (o = ye(e)).length; r < i; r++) ze(o[r], a[r]);
                    if (t)
                        if (n)
                            for (o = o || ye(e), a = a || ye(s), r = 0, i = o.length; r < i; r++) Pe(o[r], a[r]);
                        else Pe(e, s);
                    return (a = ye(s, "script")).length > 0 && we(a, !l && ye(e, "script")), s
                },
            ...
            function Ue(e, t, n) {
                ...
                return (n = n || Be(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || ae(e) || (a = E.style(e, t)), !g.pixelBoxStyles() && Fe.test(a) && Ve.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
            }
            ...
            function rt(e, t, n) {
                ...
                return (!g.boxSizingReliable() && i || !g.reliableTrDimensions() && A(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === E.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === E.css(e, "boxSizing", !1, r), (o = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + nt(e, t, n || (i ? "border" : "content"), o, r, a) + "px"
            }
                ...
                style: function(e, t, n, r) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        var i, o, a, s = Y(t),
                            l = Je.test(t),
                            c = e.style;
                        if (l || (t = Ke(s)), a = E.cssHooks[t] || E.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : c[t];
                        "string" === (o = typeof n) && (i = re.exec(n)) && i[1] && (n = ce(e, t, i), o = "number"), null != n && n == n && ("number" !== o || l || (n += i && i[3] || (E.cssNumber[s] ? "" : "px")), g.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (l ? c.setProperty(t, n) : c[t] = n))
                    }
                },
                css: function(e, t, n, r) {
                    var i, o, a, s = Y(t);
                    return Je.test(t) || (t = Ke(s)), (a = E.cssHooks[t] || E.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = Ue(e, t, r)), "normal" === i && t in et && (i = et[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
                }
            }), E.each(["height", "width"], (function(e, t) {
                E.cssHooks[t] = {
                    get: function(e, n, r) {
                        if (n) return !Ge.test(E.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? rt(e, t, r) : We(e, Ze, (function() {
                            return rt(e, t, r)
                        }))
                    },
                    set: function(e, n, r) {
                        var i, o = Be(e),
                            ...
                            l = r ? nt(e, t, r, s, o) : 0;
                        return s && a && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - nt(e, t, "border", !1, o) - .5)), l && (i = re.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = E.css(e, t)), tt(0, n, l)
                    }
                }
            ...
            function ct() {
                at && (!1 === y.hidden && n.requestAnimationFrame ? n.requestAnimationFrame(ct) : n.setTimeout(ct, E.fx.interval), E.fx.tick())
            }
            ...
            function ht(e, t, n) {
                ...
                for (! function(e, t) {
                    ...
                    if (r = ht.prefilters[o].call(c, e, u, c.opts)) return v(r.stop) && (E._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)), r;
            ...
            E.Animation = E.extend(ht, {
                    ...
                    prefilters: [function(e, t, n) {
                        ...
                        if ((l = !E.isEmptyObject(t)) || !E.isEmptyObject(h))
                            for (r in f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = g && g.display) && (c = G.get(e, "display")), "none" === (u = E.css(e, "display")) && (c ? u = c : (de([e], !0), c = e.style.display || c, u = E.css(e, "display"), de([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === E.css(e, "float") && (l || (d.done((function() {
                                    p.display = c
            ...
            E.extend(E.event, {
                trigger: function(e, t, r, i) {
                    var o, a, s, l, c, u, f, d, p = [r || y],
                        m = h.call(e, "type") ? e.type : e,
                        g = h.call(e, "namespace") ? e.namespace.split(".") : [];
                    if (a = d = s = r = r || y, 3 !== r.nodeType && 8 !== r.nodeType && !xt.test(m + E.event.triggered) && (m.indexOf(".") > -1 && (g = m.split("."), m = g.shift(), g.sort()), c = m.indexOf(":") < 0 && "on" + m, (e = e[E.expando] ? e : new E.Event(m, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = g.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : E.makeArray(t, [e]), f = E.event.special[m] || {}, i || !f.trigger || !1 !== f.trigger.apply(r, t))) {
                        if (!i && !f.noBubble && !b(r)) {
                            for (l = f.delegateType || m, xt.test(l + m) || (a = a.parentNode); a; a = a.parentNode) p.push(a), s = a;
                            s === (r.ownerDocument || y) && p.push(s.defaultView || s.parentWindow || n)
                        }
                        for (o = 0;
                            (a = p[o++]) && !e.isPropagationStopped();) d = a, e.type = o > 1 ? l : f.bindType || m, (u = (G.get(a, "events") || Object.create(null))[e.type] && G.get(a, "handle")) && u.apply(a, t), (u = c && a[c]) && u.apply && X(a) && (e.result = u.apply(a, t), !1 === e.result && e.preventDefault());
                        return e.type = m, i || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(p.pop(), t) || !X(r) || c && v(r[m]) && !b(r) && ((s = r[c]) && (r[c] = null), E.event.triggered = m, e.isPropagationStopped() && d.addEventListener(m, Et), r[m](), e.isPropagationStopped() && d.removeEventListener(m, Et), E.event.triggered = void 0, s && (r[c] = s)), e.result
                    }
                },
            ...
            Ft.href = Tt.href, E.extend({
                ...
                ajax: function(e, t) {
                    ...
                    var r, i, o, a, s, l, c, u, f, d, h = E.ajaxSetup({}, t),
                        p = h.context || h,
                    ...
                    if (h.data && h.processData && "string" != typeof h.data && (h.data = E.param(h.data, h.traditional)), Wt(zt, h, t, T), c) return T;
                    for (f in (u = E.event && h.global) && 0 == E.active++ && E.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Ht.test(h.type), i = h.url.replace(Lt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(jt, "+")) : (d = h.url.slice(i.length), h.data && (h.processData || "string" == typeof h.data) && (i += (kt.test(i) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (i = i.replace(Mt, "$1"), d = (kt.test(i) ? "&" : "?") + "_=" + Ct.guid++ + d), h.url = i + d), h.ifModified && (E.lastModified[i] && T.setRequestHeader("If-Modified-Since", E.lastModified[i]), E.etag[i] && T.setRequestHeader("If-None-Match", E.etag[i])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && T.setRequestHeader("Content-Type", h.contentType), T.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + qt + "; q=0.01" : "") : h.accepts["*"]), h.headers) T.setRequestHeader(f, h.headers[f]);
                    if (h.beforeSend && (!1 === h.beforeSend.call(p, T, h) || c)) return T.abort();
                    if (x = "abort", v.add(h.complete), T.done(h.success), T.fail(h.error), r = Wt(Rt, h, t, T)) {
                    ...
                    function C(e, t, a, l) {
                        var f, d, y, w, _, x = t;
                        c || (c = !0, s && n.clearTimeout(s), r = void 0, o = l || "", T.readyState = e > 0 ? 4 : 0, f = e >= 200 && e < 300 || 304 === e, a && (w = function(e, t, n) {
                        ...
                        }(h, T, a)), !f && E.inArray("script", h.dataTypes) > -1 && (h.converters["text script"] = function() {}), w = function(e, t, n, r) {
                            var i, o, a, s, l, c = {},
                                u = e.dataTypes.slice();
                            if (u[1])
                        ...
                        }(h, w, T, f), f ? (h.ifModified && ((_ = T.getResponseHeader("Last-Modified")) && (E.lastModified[i] = _), (_ = T.getResponseHeader("etag")) && (E.etag[i] = _)), 204 === e || "HEAD" === h.type ? x = "nocontent" : 304 === e ? x = "notmodified" : (x = w.state, d = w.data, f = !(y = w.error))) : (y = x, !e && x || (x = "error", e < 0 && (e = 0))), T.status = e, T.statusText = (t || x) + "", f ? g.resolveWith(p, [d, x, T]) : g.rejectWith(p, [T, x, y]), T.statusCode(b), b = void 0, u && m.trigger(f ? "ajaxSuccess" : "ajaxError", [T, h, f ? d : y]), v.fireWith(p, [T, x]), u && (m.trigger("ajaxComplete", [T, h]), --E.active || E.event.trigger("ajaxStop")))
                    }
                    return T
                },
            ...
            E.ajaxSetup({
                ...
                if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = v(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Xt, "$1" + i) : !1 !== e.jsonp && (e.url += (kt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
                    ...
                    void 0 === o ? E(n).removeProp(i) : n[i] = o, e[i] && (e.jsonpCallback = t.jsonpCallback, Yt.push(i)), a && v(o) && o(a[0]), a = o = void 0
                })), "script"
            })), g.createHTMLDocument = ((Qt = y.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Qt.childNodes.length), E.parseHTML = function(e, t, n) {
                return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (g.createHTMLDocument ? ((r = (t = y.implementation.createHTMLDocument("")).createElement("base")).href = y.location.href, t.head.appendChild(r)) : t = y), o = !n && [], (i = D.exec(e)) ? [t.createElement(i[1])] : (i = xe([e], t, o), o && o.length && E(o).remove(), E.merge([], i.childNodes)));
                var r, i, o
            }, E.fn.load = function(e, t, n) {
                var r, i, o, a = this,
                    s = e.indexOf(" ");
                return s > -1 && (r = bt(e.slice(s)), e = e.slice(0, s)), v(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), a.length > 0 && E.ajax({
                    url: e,
                    type: i || "GET",
                    dataType: "html",
                    data: t
                ...
                setOffset: function(e, t, n) {
                    var r, i, o, a, s, l, c = E.css(e, "position"),
                        u = E(e),
                        f = {};
                    "static" === c && (e.style.position = "relative"), s = u.offset(), o = E.css(e, "top"), l = E.css(e, "left"), ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1 ? (a = (r = u.position()).top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(l) || 0), v(t) && (t = t.call(e, n, E.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + i), "using" in t ? t.using.call(e, f) : ("number" == typeof f.top && (f.top += "px"), "number" == typeof f.left && (f.left += "px"), u.css(f))
                }
            }, E.fn.extend({
                offset: function(e) {
            ...
            }, E.isArray = Array.isArray, E.parseJSON = JSON.parse, E.nodeName = A, E.isFunction = v, E.isWindow = b, E.camelCase = Y, E.type = x, E.now = Date.now, E.isNumeric = function(e) {
                var t = E.type(e);
    ...
    79: function(e, t, n) {
        ...
        r.c.add(i.f), r.c.add(i.v), r.c.add(i.k), r.c.add(i.q), r.c.add(i.r), r.c.add(i.i), r.c.add(i.I), r.c.add(i.h), r.c.add(i.g), r.c.add(i.j), r.c.add(i.m), r.c.add(i.J), r.c.add(i.L), r.c.add(i.D), r.c.add(i.x), r.c.add(i.N), r.c.add(i.w), r.c.add(i.u), r.c.add(i.B), r.c.add(i.p), r.c.add(i.P), r.c.add(i.H), r.c.add(i.n), r.c.add(i.M), r.c.add(i.o), r.c.add(i.C), r.c.add(i.A), r.c.add(i.F), r.c.add(i.E), r.c.add(i.K), r.c.add(i.z), r.c.add(i.t), r.c.add(i.e), r.c.add(i.s), r.c.add(i.a), r.c.add(i.b), r.c.add(i.c), r.c.add(i.d), r.c.add(i.O), r.c.add(i.y), r.c.add(i.G), r.c.add(a), r.c.add(o), r.c.add(l), r.c.add(s), r.a.watch({
